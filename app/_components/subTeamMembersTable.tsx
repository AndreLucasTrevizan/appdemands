...
import { listSubTeamMembers } from "../teams/actions";

export default function SubTeamMembersTable({
  slug,
}: {
  slug: string,
}) {
  ...
  useEffect(() => {
    async function loadMembersData() {
      try {
        ...
        const data = await listSubTeamMembers(slug);
  ...
  const items = useMemo(() => {
    ...
    console.log(filteredItems.slice(start, end));
